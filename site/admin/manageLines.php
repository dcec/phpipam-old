...
/* get current devices */
$devices = getAllUniqueLines();

/* get custom fields */
$custom = getCustomFields('lines');

?>

<h4><?php print _('Lines management'); ?></h4>
<hr>
<div class="btn-group">
	<button class='btn btn-sm btn-default editSwitch' disabled data-action='add'   data-switchid='' style='margin-bottom:10px;'><i class='fa fa-plus'></i> <?php print _('Add device'); ?></button>
</div>
